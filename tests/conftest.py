...
from chillax.adapters import memory_repository, database_repository
from chillax.adapters.orm import metadata, map_model_to_tables
from chillax.adapters.memory_repository import MemoryRepository

# TODO: You have to adapt these paths to your file structure

TEST_DATA_PATH_MEMORY = r'/Users/rickys.k/Google Drive/UNIVERSITY/MY COURSES/CS 235 - METHODOLOGIES/ASSIGNMENTS/A2-Final/chillax-app/tests/data/memory'
TEST_DATA_PATH_DATABASE = r'/Users/rickys.k/Google Drive/UNIVERSITY/MY COURSES/CS 235 - METHODOLOGIES/ASSIGNMENTS/A2-Final/chillax-app/tests/data/database'


TEST_DATABASE_URI_IN_MEMORY = 'sqlite://'
TEST_DATABASE_URI_FILE = 'sqlite:///chillax.db'
