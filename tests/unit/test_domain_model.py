...
from chillax.domain.model import User, Movies, Tag, make_comment, make_tag_association, ModelException
...
def test_article_construction(article):
    ...
    assert repr(
        article) == '<Movies 2020-03-15 Coronavirus travel restrictions: Self-isolation deadline pushed back to give airlines breathing room>'
